...
namespace Dqe.Infrastructure.Repositories.Custom
{
    public class ProposalRepository : BaseRepository, IProposalRepository
    {
        ...
        public void BuildReportProposal(long proposalId, DqeUser owner, IPayItemMasterRepository payItemMasterRepository, IReportRepository reportRepository, IWebTransportService webTransportService)
        {
            ...
            CreateReportProjectData(reportProposal, projectEstimates, payItems, dateForComparison, wtProposal, proposalTotal);
        ...
        private static void CreateReportProjectData(ReportProposal reportProposal, List<ProjectEstimate> projectEstimates, List<PayItemMaster> payItems, DateTime dateForComparison, Domain.Model.Wt.Proposal wtProposal, EstimateTotal proposalTotal)
        {
