...
namespace Dqe.Infrastructure.Messaging
{
    ...
    /// COMPONENT TEMPLATE
    /// </summary>
    public class EntityAddedMessage : IMessage
    {
        private readonly EntityPersistenceContext _entityPersistenceContext;
        private readonly object _entity;

        public EntityAddedMessage(object entity, EntityPersistenceContext entityPersistenceContext)
        {
            _entity = entity;
