...
namespace Dqe.Domain.Fdot
{
    public interface IWebTransportService
    {
        ...
        IList<ProposalItemDTO> GetUnitPriceDetails(string payItem, int months, string contractWorkType, DateTime? startDate, DateTime? endDate, string[] counties, string bidStatus);
