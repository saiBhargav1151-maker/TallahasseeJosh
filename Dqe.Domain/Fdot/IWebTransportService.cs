...
namespace Dqe.Domain.Fdot
{
    public interface IWebTransportService
    {
        ...
        IList<ProposalItemDTO> GetUnitPriceDetails(string payItem, string contractType, int months, string contractWorkType, DateTime? startDate, DateTime? endDate, string[] counties, string bidStatus, string[] marketCounties, decimal? minRank, decimal? maxRank, List<string> workTypeNames);
