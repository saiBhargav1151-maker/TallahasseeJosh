...
namespace Dqe.Domain.Model
{
    public class ProjectItem : Entity<Transformers.ProjectItem>
    {
        ...
        [StringLength(12)]
        public virtual string UnknownPayItemNumber { get; protected internal set; }

        [StringLength(256)]
        public virtual string UnknownPayItemDescription { get; protected internal set; }
        ...
        public override Transformers.ProjectItem GetTransformer()
        {
            return new Transformers.ProjectItem
            {
                ...
                Quantity = Quantity,
                Price = Price,
                UnknownPayItemDescription = UnknownPayItemDescription,
                UnknownPayItemNumber = UnknownPayItemNumber
            };
        }
        ...
        public override void Transform(Transformers.ProjectItem transformer, DqeUser account)
        {
            ...
            UnknownPayItemNumber = transformer.UnknownPayItemNumber;
            UnknownPayItemDescription = transformer.UnknownPayItemDescription;
        }
    }
}