...
namespace Dqe.Domain.Model
{
    public class CostBasedTemplate : Entity<Transformers.CostBasedTemplate>
    {
        ...
        private readonly ICollection<PayItemStructure> _payItemStructures = new Collection<PayItemStructure>();
        private readonly ICollection<PayItem> _payItems = new Collection<PayItem>();
