...
namespace Dqe.Domain.Model
{
    public class PayItemMaster : Entity<Transformers.PayItemMaster>
    {
        ...
        public virtual void RemoveCostGroup(CostGroupPayItem costGroupPayItem)
        {
            costGroupPayItem.MyPayItem = null;
        }

        public virtual PayItemStructure MyPayItemStructure { get; protected internal set; }

        public virtual void SetPayItemStructure(PayItemStructure payItemStructure)
        {
        ...
        public virtual void SetCostBasedTemplate(CostBasedTemplate costBasedTemplate)
        {
        ...
        public virtual bool IsFrontLoadedItem { get; set; }
        ...
        public override Transformers.PayItemMaster GetTransformer()
        {
            return new Transformers.PayItemMaster
            {
                ...
                IsFrontLoadedItem = IsFrontLoadedItem,
                Ildt2 = Ildt2,
        ...
        public override void Transform(Transformers.PayItemMaster transformer, DqeUser account)
        {
            ...
            IsFrontLoadedItem = transformer.IsFrontLoadedItem;
