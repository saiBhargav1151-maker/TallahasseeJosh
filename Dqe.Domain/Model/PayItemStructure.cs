...
namespace Dqe.Domain.Model
{
    public class PayItemStructure : Entity<Transformers.PayItemStructure>
    {
        ...
        //private readonly ICollection<PrimaryUnit> _primaryUnits;
        ...
        public PayItemStructure(IPayItemStructureRepository payItemStructureRepository)
        {
            ...
            //_primaryUnits = new Collection<PrimaryUnit>();
        ...
        //public virtual IEnumerable<PrimaryUnit> PrimaryUnits
        //{
        //    get { return _primaryUnits.ToList().AsReadOnly(); }
        //}
        ...
        public override void Transform(Transformers.PayItemStructure transformer, DqeUser account)
        {
            ...
            EffectiveDate = transformer.EffectiveDate == DateTime.MinValue ? DateTime.MaxValue : transformer.EffectiveDate;
            ...
            ObsoleteDate = transformer.ObsoleteDate.HasValue ? transformer.ObsoleteDate.Value == DateTime.MinValue ? null : transformer.ObsoleteDate : null;
            ...
            SecondaryUnit = PrimaryUnit == PrimaryUnitType.LumpSum ? transformer.SecondaryUnit : null;
        }
        ...
        public override IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (PrimaryUnit == PrimaryUnitType.NotSet)
            {
                yield return new ValidationResult("Primary Unit is required.");
            }
            if (PrimaryUnit == PrimaryUnitType.LumpSum && (!SecondaryUnit.HasValue ||  SecondaryUnit.Value == SecondaryUnitType.NotSet))
            {
