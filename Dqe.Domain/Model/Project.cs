            ...
            foreach (var eg in source.Categories)
            {
                ...
                foreach (var pi in eg.ProjectItems)
                {
                    ...
                    var p = new ProjectItem
                    {
                        ...
                        ItemClass =
                            string.IsNullOrWhiteSpace(pi.MyRefItem.ItemClass) ? string.Empty : pi.MyRefItem.ItemClass,
                        ContractClass =
                            string.IsNullOrWhiteSpace(pi.MyRefItem.ContractClass)
                                ? string.Empty
                                : pi.MyRefItem.ContractClass,
            ...
            foreach (var eg in source.EstimateGroups)
            {
                ...
                foreach (var pi in eg.ProjectItems)
                {
                    var p = new ProjectItem
                    {
                        ...
                        ItemClass = pi.ItemClass,
                        ContractClass = pi.ContractClass,
