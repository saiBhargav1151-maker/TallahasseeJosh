...
namespace Dqe.Domain.Model
{
    public class Project : Entity<Transformers.Project>
    {
        ...
        public virtual ProjectEstimate CreateNewVersionFromWt(string comment, Wt.Project source, DqeUser account)
        {
            if (account == null) throw new ArgumentNullException("account");
            if (account.Role != DqeRole.System && account.Role != DqeRole.Administrator && account.Role != DqeRole.DistrictAdministrator && account.Role != DqeRole.Estimator)
            {
        ...
        protected internal virtual void RemoveLabel(SnapshotLabel label)
        {
        ...
        protected internal virtual void SnapshotWorkingEstimate(DqeUser account, bool labelSnapshot, bool proposalOverride)
        {
            if (account == null) throw new ArgumentNullException("account");
            if (account.Role != DqeRole.System && account.Role != DqeRole.Administrator && account.Role != DqeRole.DistrictAdministrator && account.Role != DqeRole.Estimator)
            {
        ...
        {
            SnapshotWorkingEstimate(account, labelSnapshot, false);
        }
        ...
        protected internal virtual SnapshotLabel GetNextProposalSnapshotLabel()
        {
            ...
            if (hasPhase3) return SnapshotLabel.Authorization;
            if (hasPhase2) return SnapshotLabel.Phase3;
            return SnapshotLabel.Phase2;
        }
