...
namespace Dqe.Domain.Model.Reports
{
    public class ReportProposal
    {
        ...
        public virtual bool InvalidEstimate { get; set; }
        ...
        public virtual ReportLetting MyReportLetting { get; set; }
        ...
        public virtual void ClearProposalVendors()
        {
            _reportProposalVendors.Clear();
        }
