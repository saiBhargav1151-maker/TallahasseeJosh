dqeControllers.controller('AdminPayItemsMaintainController', ['$scope', '$rootScope', '$http', function ($scope, $rootScope, $http) {
    ...
    function loadPayItems(viewAll) {
        $http.get('./payitemstructureadministration/GetPayItemStructures', { params: { viewAll: viewAll } }).success(function (result) {
