...
dqeApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.
        ...
        when('/home_reports_snapshot_comparison', {
            templateUrl: './Views/partials/home_reports_snapshot_comparison.html',
            controller: 'HomeReportsSnapshotComparisonController'
        }).
...
// ReSharper restore InconsistentNaming
    ...
    blockUIConfigProvider.requestFilter(function (config) {
        ...
        if (config.url.match(/^\.\/projectproposal\/GetDqeProposals($|\/).*/)) {
            return false; // ... don't block it.
        }
        ...
        if (config.url.match(/^\.\/estimate\/GenerateParameterPrices($|\/).*/)) {
            return false; // ... don't block it.
        }
        return true;
    });
