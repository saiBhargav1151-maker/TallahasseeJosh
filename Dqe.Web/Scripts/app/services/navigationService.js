                    ...
                    return [
                        {
                            ...
                            active: $location.url() == '/home_selection_project' || $location.url().startsWith('/home_selection_project/'),
                            url: '/home_selection_project'
                        },
                        //{
                        //    title: 'Project (Mock)',
                        ...
                        {
                            title: 'Proposal',
                            active: $location.url() == '/home_selection_proposal' || $location.url().startsWith('/home_selection_proposal/'),
                            url: '/home_selection_proposal'
                        }
                        //{
                        //    title: 'Proposal (Mock)',
                        //    active: $location.url().startsWith('/home_selection_proposal_mock'),
                        //    url: '/home_selection_proposal_mock'
                        //},
                        //{
                        //    title: 'LRE',
