                ...
                if ($location.url().startsWith('/home_reports')) {
                    return [
                        ...
                        },
                        {
                            ...
                            active: $location.url().startsWith('/home_reports_snapshot_comparison'),
                            url: '/home_reports_snapshot_comparison'
                        },
                        {
                            title: 'Bid Tolerance Levels',
                        ...
                        {
                            title: 'Executive Summary of Letting',
