dqeDirectives.directive('pricing', function () {
    return {
        ...
        controller: ['$scope', '$rootScope', '$http', '$filter', '$location', 'stateService', 'fileUpload', '$localStorage',  function ($scope, $rootScope, $http, $filter, $location, stateService, fileUpload, $localStorage) {
