...
angular.module('angular-growl').directive('growl', [
  ...
  function ($rootScope) {
      ...
      return {
          restrict: 'A',
          templateUrl: './Views/partials/growl.html',
          replace: false,
          scope: true,
          controller: [
            '$scope',
            ...
            function ($scope, $timeout, growl) {
                ...
                $rootScope.$on('growlClearMessages', function (event) {
...
angular.module('angular-growl').provider('growl', function () {
    'use strict';
    var _ttl = null, _enableHtml = false, _messagesKey = 'messages', _messageTextKey = 'text', _messageSeverityKey = 'severity', _onlyUniqueMessages = true, _timeToLiveKey="ttl";
    ...
    this.timeToLiveKey = function (timeToLiveKey) {
        _timeToLiveKey = timeToLiveKey;
    };
    ...
    this.$get = [
      ...
      function ($rootScope, $filter) {
          ...
          function addServerMessages(messages) {
              $rootScope.$broadcast('growlClearMessages');
              ...
              for (i = 0; i < length; i++) {
                  ...
                  if (message[_messageTextKey] && message[_messageSeverityKey]) {
                      ...
                      var ttlFromMessage = message[_timeToLiveKey];
                      if (ttlFromMessage == undefined || ttlFromMessage == null || ttlFromMessage == 0) {
                          sendMessage(message[_messageTextKey], undefined, severity);
                      } else {
                          sendMessage(message[_messageTextKey], { ttl: ttlFromMessage }, severity);
                      }
                  }
              }
          }
