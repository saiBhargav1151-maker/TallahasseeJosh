...
namespace Dqe.Web.Controllers
{
    ...
    public class PayItemStructureAdministrationController : Controller
    {
        ...
        [HttpGet]
        public ActionResult GetPayItemStructures(bool viewAll, int range)
        {
            var items = _payItemStructureRepository.GetAll(viewAll, range)
                .Select(i => new
                {
                    id = i.Id,
        ...
        public ActionResult UpdatePayItemStructure(dynamic payItemStructure)
        {
            ...
            if (payItemStructure.boeRecentChangeDate != null && !string.IsNullOrWhiteSpace(payItemStructure.boeRecentChangeDate.ToString()))
            {
            ...
            if (payItemStructure.effectiveDate != null && !string.IsNullOrWhiteSpace(payItemStructure.effectiveDate.ToString()))
            {
            ...
            if (payItemStructure.obsoleteDate != null && !string.IsNullOrWhiteSpace(payItemStructure.obsoleteDate.ToString()))
            {
