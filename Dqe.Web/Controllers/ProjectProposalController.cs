        ...
        private ActionResult ResultStructureFromProjectSelection(Project project, DqeUser currentUser)
        {
            ...
            return new DqeResult(new
            {
                project = new
                {
                    ...
                    lettingDate = project.LettingDate.HasValue ? project.LettingDate.Value.ToShortDateString() : string.Empty,
        ...
        private ActionResult ResultStructureFromSnapshot(ProjectEstimate snapshot, DqeUser currentUser)
        {
            return new DqeResult(new
            {
                project = new
                {
                    ...
                    comment = snapshot.EstimateComment,
                    lettingDate = snapshot.MyProjectVersion.MyProject.LettingDate.HasValue ? snapshot.MyProjectVersion.MyProject.LettingDate.Value.ToShortDateString() : string.Empty,
